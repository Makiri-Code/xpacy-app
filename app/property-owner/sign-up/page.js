...
import { getCities } from "@/app/_lib/data-services";
                ...
                <div className="flex flex-col gap-12">
                    ...
                    <div className="space-y-11">
                        <div className="space-y-2 text-center">
                            <h1 className="text-4xl text-primary font-bold">Property Owner Sign Up</h1>
                            <p className="text-base text-black font-mono">Create an account to list and manage your properties.</p>
                        </div>
                        <SignupForm cities={cities} role="property-owner"/>
