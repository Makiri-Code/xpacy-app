...
const Window = ({ children, name, property_id }) => {
    ...
    return createPortal(
        <div className="fixed top-0 w-full left-0 bottom-0 h-screen bg-black/40 backdrop-blur-[2px] z-50 transition-all duration-200 ease-in flex items-center justify-center p-4">
            <div ref={ref} className="relative bg-white rounded-2xl shadow-xl transition-all duration-200 w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95">
