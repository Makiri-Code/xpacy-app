    ...
    return (
        <div className="flex flex-col p-6 gap-6 border border-primary-200 bg-white rounded-lg">
            <header className="flex items-center justify-between relative">
                <h2 className="text-md">Service Overview</h2>
            ...
            {/* Table Header */}
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_0.5fr] text-neutrals-900 text-sm font-mono font-bold border-b border-primary-100">
            ...
            {/* Body */}
            {
                bookings?.map((booking) => {
                    return (
                        <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_0.5fr] text-neutrals-900 text-sm font-mono border-b border-primary-100" key={booking.id}>
                        ...
                        <p className="p-4 flex items-center justify-center">
                            <span className={`bg-error text-secondary-100 w-max  px-1.5 py-1 flex items-center justify-center rounded-full  text-sm font-bold font-mono`}>{booking?.status}</span>
                        </p>
                        <p className="p-4 flex items-center justify-center">
