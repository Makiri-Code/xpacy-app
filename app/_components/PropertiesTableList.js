        ...
        <div className="flex flex-col gap-6 p-6 border-[1.5px] border-primary-200 rounded-lg">
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody>
                        {(recent ? properties.slice(0, 4) : properties).map((property) => {
                            const reserveAmount = property.reserve_amount;
                            ...
                            return (
                                <tr key={property.id || property._id} className="text-neutrals-900 text-sm font-mono border-b border-primary-100 hover:bg-gray-50/50 transition-colors">
                                    <td className="p-4">
                                    ...
                                    <td className="p-4 text-center text-primary font-bold">
                                         {reserveAmount ? formatCurrency(reserveAmount) : "N/A"}
                                    </td>
            ...
            <div className="lg:hidden flex flex-col bg-white border border-primary-100 rounded-xl overflow-hidden shadow-sm">
                {(recent ? properties.slice(0, 4) : properties).map((property) => {
                    ...
                    return (
                        <div key={property.id || property._id} className="flex flex-col gap-4 p-4 border-b border-primary-100 bg-white last:border-0">
                            ...
                            <div className="flex flex-col gap-2 text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
                                ...
                                <div className="flex justify-between items-center">
                                    <span>Price:</span>
                                    <span className="font-medium text-gray-900">{formatCurrency(property.property_price)}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span>Reserve Amount:</span>
                                    <span className="font-medium text-gray-900">{formatCurrency(property.reserve_amount)}</span>
                                </div>
                            </div>
                        </div>
                    );
